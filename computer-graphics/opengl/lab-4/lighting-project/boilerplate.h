//
// Created by mattfor on 5/1/26.
//

#ifndef LIGHTINGPROJECT_BOILERPLATE_H
#define LIGHTINGPROJECT_BOILERPLATE_H
...
{
    return std::format("Laboratorium 4 - Zadanie {} - REDACTED 155197", task_id);
}
...
static void draw_scene_axes()
{
    ...
    constexpr point_3d x_beg = { -1000., 0., 0. };
    constexpr point_3d x_end = { 1000., 0., 0. };

    constexpr point_3d y_beg = { 0., -1000., 0. };
    constexpr point_3d y_end = { 0., 1000., 0. };

    constexpr point_3d z_beg = { 0., 0., -1000. };
    constexpr point_3d z_end = { 0., 0., 1000. };
...
// ReSharper disable once CppFunctionIsNotUsed
...
/**
    ...
    */
inline auto B = [](const int i, const float t) -> float
{
    const float u = 1.f - t;
    switch (i)
    {
...
inline auto dB = [](const int i, const float t) -> float
{
    const float s = 1.f - t;
    switch (i)
    {
        ...
        case 1:
        {
            return 3.f * s * s - 6.f * t * s;
        }

        case 2:
        {
            return 6.f * t * s - 3.f * t * t;
        }
...
#endif //LIGHTINGPROJECT_BOILERPLATE_H
